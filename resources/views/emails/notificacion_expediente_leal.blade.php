                                    ...
                                    <td>
                                        ...
                                        <div class="noticia">
                                            <p style="text-align: justify;">
                                                ...
                                                le adjunta información.
                                            </p>
                                            <p style="text-align: justify;">
                                                <strong>
                                                    Importante:
                                                </strong>
                                                &nbsp;Recuerde leer la documentación adjunta. En caso de corresponder, presentar la documentación solicitada.
                                                <br />
                                                <br />
                                                <strong>
                        ...
                        <tbody>
                            <tr style="height: 118px;">
                                <td style="width: 527px; height: 118px;">
                                    ...
                                    <p class="callout" style="text-align: center;">
                                        <strong>Whatsapp: +54 9 11 6163-4437
                                            <br /> 
                                            Email:
                                            <span class="negro">
                            ...
                            <tr>
                                <td style="width: 525px; text-align: center;">&nbsp; &nbsp; &nbsp; &nbsp;
                                    ...
                                    <div class="content">
                                        <strong>
                                            <span class="telefono">
                                                011-5263-3206/3204 (interno 105)
                                            </span>
                                        </strong>
                                    </div>
                                    <div class="content">
                                        <span class="negro">
                                            <span class="chico">
                                                Informaci&oacute;n de lunes a viernes de 8 a 18 hs
                                                <br />
                                    ...
                                    <p>&nbsp;
                                        <span class="negro">E</span>
                                        <span class="negro">-mail: 
                                            <strong>
                                                <a href="mailto:asesoramiento@lealmedica.com.ar" 
                                                    target="_blank" 
                                                    rel="noopener">
