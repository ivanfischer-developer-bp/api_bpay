    ...
    public function generar_ejemplo_factura(Request $request)
    {
        ...
        try {
            ...
            if($user->hasPermissionTo($permiso_requerido)){
                ...
                // código qr
                // generamos el código y lo guardamos en public/storage/images/qrcode.png
                ...
                $pdf->SetLineWidth(0.5);
                $pdf->Cell(28, 10, '$ '.utf8_decode($data['imp_total']), 1, 0, 'R', TRUE);
                // FIN DETALLE --------------------------------------------------------------------------------------------------------
                ...
                // imagen ms_children
                $pdf->Image(storage_path('app/public/images/').$data['imagen'], 15, 192, 110, 0, 'PNG');
                ...
                // get_code39($pdf, 130, 196, $data['cod_corto'], 0.5, 15);
                ...
                // logo chico
                // $pdf->Image(storage_path('app/public/images/logo_Casa_Sistema_asitencial_small.png'), 15, 231, 50, 27, 'PNG');
                ...
                $pdf->SetFillColor(0,0,0);
                // get_code39($pdf, 55, 261, $data['cod_largo'], 0.6, 6);
                // número del código de barras
                $pdf->SetFont('Arial','',9);
                $pdf->SetTextColor(0,0,0);
                $pdf->SetY(268);
                ...
                $pdf->Cell(144, 4, get_code39($pdf, 55, 261, $data['cod_largo'], 0.6, 6), 0, 0, 'C');
