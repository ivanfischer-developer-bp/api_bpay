...
class RecetasController extends ConexionSpController
{
    /**
    ...
    public function buscar_receta(Request $request)
    {
        ...
        // try {
            // $req = [];
            // $req['nroReceta'] = request('nro_receta');
            // if(request('dni') != null){
            //     $req['dni'] = request('dni');
            // }
    ...
    public function listar_recetas_emitidas(Request $request)
    {
        $extras = [
            'api_software_version' => config('site.software_version'),
            'ambiente' => config('site.ambiente'),
            'url' => '/int/recetas/listar-recetas-emitidas',
            'controller' => explode('\\', __CLASS__)[sizeof(explode('\\', __CLASS__))-1],
            'function' => __FUNCTION__,
            'queries' => [],
            'responses' => [],
    ...
    public function generar_receta_medicamentos(Request $request)
    {
        ...
        $extras = [
            'api_software_version' => config('site.software_version'),
            'ambiente' => config('site.ambiente'),
            'url' => '/int/recetas/generar-receta',
            'controller' => explode('\\', __CLASS__)[sizeof(explode('\\', __CLASS__))-1],
            'function' => __FUNCTION__,
            'sps' => [],
            'responses' => [],
