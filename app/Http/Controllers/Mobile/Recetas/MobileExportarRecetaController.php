...
class MobileExportarRecetaController extends ConexionSpController
{
    /**
    ...
    public function generar_pdf_receta(Request $request)
    {
        $extras = [
            ...
            'url' => 'mobile/recetas/generar-pdf-receta',
        ...
        try {
            ...
            if($user->hasPermissionTo('exportar datos')){
                ...
                return $this->crear_pdf_receta($nro_receta, $accion, 'mobile/recetas/generar-pdf-receta', $logged_user);  
